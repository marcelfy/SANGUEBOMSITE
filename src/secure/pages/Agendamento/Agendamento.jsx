...
import { Form, FormItem, Input, message, Button } from 'antd'
            ...
            >
                <fieldset className={Styles.containerForm}>
                    <Form.Item
                        ...
                        style={{ width: '100%' }}
                    >
                        <Input className={Styles.input} placeholder="Digite seu nome" style={{ border: '1px solid #386F61', borderRadius: '10px' }} />
                    </Form.Item>
                    <div style={{ display: 'flex' }}>
                        ...
                        <Form.Item
                            ...
                            style={{ width: '60%' }}
                        >
                            <MaskedInput mask="99/99/9999" className={Styles.input} placeholder="Informe a data de nascimento" style={{ borderRadius: '10px', border: '1px solid #386F61', width: '90%' }} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            style={{ width: '50%' }}
                        >
                            <MaskedInput mask='(99) 99999 9999' className={Styles.input} placeholder="Informe o telefone" style={{ border: '1px solid #386F61', borderRadius: '10px', width: '100%' }} />
                        </Form.Item>
                    </div>
                    ...
                    <div style={{ display: 'flex' }}>
                        <Form.Item
                            ...
                            style={{ width: '50%' }}
                        >
                            <MaskedInput mask="99999-999" className={Styles.input} placeholder="Informe o cep" style={{ borderRadius: '10px', border: '1px solid #386F61', width: '90%' }} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            wrapperCol={{ span: 24 }}
                        >
                            <Input placeholder='Digite seu endereço' className={Styles.input} style={{ border: '1px solid #386F61', borderRadius: '10px', width: '90%' }} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            wrapperCol={{ span: 24 }}
                        >
                            <Input placeholder='Digite o bairro' className={Styles.input} style={{ border: '1px solid #386F61', borderRadius: '10px', width: '90%' }} />
                        </Form.Item>
                    </div>
                    <div style={{ display: 'flex' }}>
                        <Form.Item
                            ...
                            wrapperCol={{ span: 24 }}
                        >
                            <Input placeholder='Digite o estado' className={Styles.input} style={{ border: '1px solid #386F61', borderRadius: '10px', width: '90%' }} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            wrapperCol={{ span: 24 }}
                        >
                            <Input placeholder='Digite a cidade' className={Styles.input} style={{ border: '1px solid #386F61', borderRadius: '10px', width: '90%' }} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            wrapperCol={{ span: 24 }}
                        >
                            <Input placeholder='Digite o número' className={Styles.input} style={{ border: '1px solid #386F61', borderRadius: '10px', width: '100%' }} />
                        </Form.Item>
                    ...
                    <div style={{display:'flex'}}>
                        <Form.Item
                            ...
                            wrapperCol={{ span: 24 }}
                        >
                            <DatePicker style={{ border: '1px solid #386F61', borderRadius: '10px', width: '90%' }} format={'DD/MM/YYYY'} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            wrapperCol={{ span: 24 }}
                        >
                            <TimePicker style={{ border: '1px solid #386F61', borderRadius: '10px', width: '100%' }}/>
                        </Form.Item>
                    </div>
